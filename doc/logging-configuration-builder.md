...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for TeslaFleetManagementApiClient initialization.
...
$logger = new Logger('TeslaFleetManagementApi');
